  ...
  render() {
    ...
    return (
      <div className={classnames} tabIndex="0" onKeyUp={this.onKeyUp.bind(this)} ref="container">
        <div className="gallery-overlay__close universal-close" onClick={this.close.bind(this)}></div>
      ...
      <div className="gallery-item">
        <div className="gallery-item--inner">
        {
          this.isImage(item) ?
            <div>
            <img src={item} />
            <a className="standard-cta" href={item} download="lorax" target="_blank">Download</a>
            </div>
          :
